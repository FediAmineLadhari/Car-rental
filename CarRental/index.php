...
<div class="mainContent">
    ...
    <div class="jumbotron jumbotron-fluid aprop" id="aprop" >
        <div class="container">
            ...
            <p class="lead">Bienvenue chez "LocationVoiture", votre destination pour la location de voitures de qualité ! Fondée par Fedi Laadheri, notre société de location de voitures est dédiée à fournir un service professionnel et fiable pour répondre à vos besoins de mobilité. Que vous soyez en voyage d'affaires, en vacances ou simplement à la recherche d'un véhicule de remplacement, nous sommes là pour vous offrir une solution de location de voitures personnalisée et pratique. Avec notre large gamme de véhicules, allant des berlines aux VUS en passant par les voitures de luxe, vous pouvez choisir le véhicule qui correspond le mieux à vos besoins et à votre style de vie. Nous sommes fiers de notre engagement envers la satisfaction du client, avec des tarifs compétitifs, un excellent service client et des options de location flexibles. Laissez-nous vous aider à partir du bon pied avec une voiture de location de qualité chez "LocationVoiture".</p>
        </div>
    </div>
